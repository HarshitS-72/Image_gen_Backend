...
const url = 'mongodb+srv://$_USERNAME_$:$_PASSWORD_$@cluster0.nm39tov.mongodb.net/$_DB_NAME_$?retryWrites=true&w=majority&appName=Cluster0';

const databaseUser = 'harshit';
const databasePassword = 'test';
const databaseName = 'img_gen';
